...
CREATE TABLE `mac` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK_6ygrbeaeiy6ibymn7r7p8409f` (`zone_ID`),
  CONSTRAINT `FK_6ygrbeaeiy6ibymn7r7p8409f` FOREIGN KEY (`zone_ID`) REFERENCES `zone` (`id`)
...
-- Dump completed on 2016-03-27  8:41:59
